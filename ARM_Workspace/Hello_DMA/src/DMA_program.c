                            ...
                            )
{
    ...
    CLR_BIT(MDMA1->Channel[0].SCR, 0);
    /*Load The Source Address*/
    MDMA1->Channel[0].SPAR = Copy_pu32SourceAddress;
    /*Load The Destination Address*/
    MDMA1->Channel[0].SM0AR = Copy_pu32DestinationAddress;
    /*Set the Block Size*/
    MDMA1->Channel[0].SNDTR = Copy_u16BlockSize;
    /*Enable The DMA Channel*/
    SET_BIT(MDMA1->Channel[0].SCR, 0);
}

// MUST BE PRIVATE FUNCTION
void MDMA1_voidClearAllFlags(void)
{
    SET_BIT(MDMA1 -> LIFCR, 0);
    SET_BIT(MDMA1 -> LIFCR, 2);
    SET_BIT(MDMA1 -> LIFCR, 3);
    SET_BIT(MDMA1 -> LIFCR, 4);
